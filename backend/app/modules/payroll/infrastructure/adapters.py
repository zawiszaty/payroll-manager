...
class PayrollDataGatheringAdapter:
    """
    ...
    async def validate_payroll_eligibility(
        ...
        has_contract = await self.contract_facade.has_active_contract(
    ...
    async def gather_all_payroll_data(
        ...
        contract_data = await self.contract_facade.get_contract_data(
...
class PayrollValidationAdapter:
    """
    ...
    async def validate_payroll_period(
        ...
        """
        # Check start date
        has_contract_start = await self.contract_facade.has_active_contract(
        ...
        # Check end date
        has_contract_end = await self.contract_facade.has_active_contract(
